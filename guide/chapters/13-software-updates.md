...
1. **Open Settings → System → Update and select Check for Updates.** The phone or computer running the browser needs internet access. The Hub does not require internet access to update.
...
- The Update page accepts a firmware file for manual fallback, and each display has its own basic update page.
